...
> **LOGIC:** When building a specific page, first check `.slash/design/pages/[page-name].md`.
> If that file exists, its rules **override** this file (`system.md`).
> If not, strictly follow the rules below.

---

**Project:** PowerPlaza
**Generated:** 2026-04-10 08:52:02
